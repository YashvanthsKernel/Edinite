    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <div className="relative h-[600px] md:h-[550px] overflow-hidden">
          <div className="absolute inset-0 flex rounded-xl">
            {/* Sign In Card - Left Side */}
            <div className="w-1/2 flex items-center justify-center px-4 z-10 relative">
              <Card className="w-full backdrop-blur-xl bg-card/50 border-primary/20 shadow-[0_8px_32px_0_rgba(114,38,255,0.15)]">
            ...
            {/* Right Side - Promotional Box + Sign Up Form */}
            <div className="w-1/2 relative">
              {/* Promotional Blue Box */}
              <motion.div
                initial={false}
                animate={{ x: isSignup ? -100 : 0 }}
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
                className="absolute inset-0 bg-primary rounded-xl flex flex-col items-center justify-center p-8 text-center z-20"
                data-testid="div-promo-box"
              >
                ...
                <Button 
                  ...
                  onClick={() => setIsSignup(true)}
                  data-testid="button-promo-signup"
                >
                  Sign Up
                </Button>
              </motion.div>
