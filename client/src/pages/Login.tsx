    ...
    <div className="min-h-screen flex items-center justify-center py-20 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="backdrop-blur-xl bg-card/50 border-primary/20 shadow-[0_8px_32px_0_rgba(114,38,255,0.15)]">
          ...
          <CardContent>
            ...
            <p className="text-center text-sm text-muted-foreground mt-6" data-testid="text-signup-prompt">
              ...
              <Link href="/signup">
                <span className="text-primary hover:text-primary/80 font-medium transition-colors cursor-pointer" data-testid="link-signup">
                  Create one now
                </span>
              </Link>
            </p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          ...
          <span className="text-primary/80 hover:text-primary cursor-pointer" data-testid="link-terms">Terms of Service</span>
          {" "}and{" "}
          <span className="text-primary/80 hover:text-primary cursor-pointer" data-testid="link-privacy">Privacy Policy</span>
        </p>
      </div>
    </div>
  );
