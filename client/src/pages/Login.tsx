          ...
          <Card className="w-full h-full backdrop-blur-xl bg-card/95 border-primary/20 shadow-[0_8px_32px_0_rgba(114,38,255,0.15)] overflow-hidden">
            <div className="flex h-full relative">
              ...
              <motion.div
                ...
                className="absolute top-0 left-0 w-1/2 h-full bg-gradient-to-br from-violet-600 via-primary to-indigo-700 rounded-2xl flex items-center justify-center p-8 text-center z-10 border-[3px] border-white/40 shadow-[0_0_20px_rgba(255,255,255,0.2),0_8px_32px_rgba(0,0,0,0.35)]"
