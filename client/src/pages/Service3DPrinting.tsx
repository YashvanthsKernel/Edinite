...
import heroImage from '@assets/generated_images/3D_printing_service_background_5fcbe0f4.png';

export default function Service3DPrinting() {
  const features = [
          ...
          <GlassPanel className="p-12">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-heading font-bold text-foreground">
                3D Printing <span className="text-primary">Services</span>
              </h1>
            </div>
            <p className="text-xl text-muted-foreground mb-8">
              Rapid prototyping and additive manufacturing solutions with FDM, SLA, and SLS technologies for functional parts
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                <h3 className="text-lg font-subheading font-semibold text-foreground mb-4">Available Materials</h3>
            ...
            <div className="flex gap-4">
              ...
              <Button asChild variant="outline" size="lg" data-testid="button-view-portfolio-3d-printing">
                <Link href="/portfolio">
                  View Portfolio
                </Link>
              </Button>
