            ...
            <div className="hidden md:flex items-center gap-4">
              <Link href="/edutech">
                <div className="relative inline-flex">
                  <div className="absolute -inset-1 bg-gradient-to-r from-primary via-purple-500 to-cyan-400 rounded-full opacity-0 blur-lg" />
                  <div className="relative inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-primary/10 via-purple-500/10 to-cyan-400/10 border border-primary/30 backdrop-blur-sm">
